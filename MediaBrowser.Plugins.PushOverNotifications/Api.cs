...
{
    [Route("/PushoverNotifications", "POST", Summary = "Saves a notification", IsHidden = true)]
    [Authenticated(Roles = "Admin")]
    public class SaveNotification : PushoverNotificationInfo, IReturnVoid
    {
    }

    [Route("/PushoverNotifications/Default", "GET", Summary = "Gets default notification info", IsHidden = true)]
    [Authenticated(Roles = "Admin")]
    public class GetDefaultNotificationInfo : IReturn<PushoverNotificationInfo>
    {
    }

    [Route("/PushoverNotifications/Send/Test", "POST", Summary = "Sends a notification request, for testing only", IsHidden = true)]
    [Authenticated(Roles = "Admin")]
    public class SendNotificationTest : PushoverNotificationInfo
    {
    }

    [Route("/PushoverNotifications", "DELETE", Summary = "Deletes a notification", IsHidden = true)]
    [Authenticated(Roles = "Admin")]
    ...
    public class NotificationsApi : IService, IRequiresRequest
    {
        ...
        {
            return new PushoverNotificationInfo();
        }
        ...
        public void Post(SaveNotification request)
        {
            ...
            var updatedNotification = _json.DeserializeFromString<PushoverNotificationInfo>(_json.SerializeToString(request));
        ...
        private InternalNotificationRequest GetSampleNotificationRequest(PushoverNotificationInfo request)
        {
